...
<div class="bg-gray-100 min-h-screen flex items-center justify-center overflow-x-hidden">
    <div class="text-center">
        ...
        <div class="space-y-4">
            <a href="{{ route('front.orders.index') }}" class="bg-green-500 text-white py-2 px-4 rounded">Pesanan Saya</a>
            <a href="{{ route('front.product') }}" class="bg-gray-300 text-gray-600 py-2 px-4 rounded">Kembali Belanja</a>
        </div>
    </div>
</div>
@endsection
