        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 border sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.partners.update', $partner->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        <x-input-label for="logo" :value="__('Logo (Upload New Image)')" />
                        ...
                        <p class="text-sm text-gray-500 mt-2">Current Icon: <img src="{{ Storage::url($partner->logo) }}" alt="Icon" class="h-10 inline-block"></p>
