                            ...
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b">
                                    <div class="flex justify-center items-center space-x-4">
                                        <a href="<?php echo e(route('admin.teams.edit', $team->id)); ?>" title="Edit">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="border-b p-4 flex flex-col gap-2">
                            <div class="flex justify-between items-center">
                                <span class="font-semibold text-gray-700">ID: <?php echo e($team->id); ?></span>
                            ...
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e(asset('storage/' . $team->image)); ?>" alt="<?php echo e($team->name); ?>" class="h-14 w-14 object-cover rounded-full">
                                <div>
                                    <div class="font-bold"><?php echo e($team->name); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e($team->occupation); ?></div>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php endif; ?>
<?php /**PATH /home/java5379/public_html/test.javajuice.id/resources/views/admin/teams/index.blade.php ENDPATH**/ ?>