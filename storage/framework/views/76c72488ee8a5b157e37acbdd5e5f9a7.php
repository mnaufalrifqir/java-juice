     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-row justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Manage Hero Section')); ?>
            ...
            <div class="bg-white shadow rounded-lg overflow-hidden">
                            ...
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b">
                                    <div class="flex justify-center items-center space-x-4">
                                        <span title="Delete">
                                            <form action="<?php echo e(route('admin.hero_sections.destroy', $hero->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this image?');">
                                                <?php echo csrf_field(); ?>
                ...
                <div class="bg-gray-50 px-4 py-2 flex justify-between items-center">
                    <?php if($hero_sections->onFirstPage()): ?>
                        <span></span>
                    <?php else: ?>
                        <a href="<?php echo e($hero_sections->previousPageUrl()); ?>" class="text-gray-500 hover:underline">Previous</a>
                    <?php endif; ?>

                    <span class="text-gray-500">
                        Showing <?php echo e($hero_sections->firstItem()); ?> - <?php echo e($hero_sections->lastItem()); ?> of <?php echo e($hero_sections->total()); ?>

                    </span>

                    <?php if($hero_sections->hasMorePages()): ?>
                        <a href="<?php echo e($hero_sections->nextPageUrl()); ?>" class="text-gray-500 hover:underline">Next</a>
                    <?php else: ?>
                        <span></span>
                    <?php endif; ?>
                </div>
