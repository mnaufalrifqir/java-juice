    ...
    <main class="container mx-auto my-10">
        <div class="bg-white p-10 rounded-lg shadow-md">
            ...
            <div class="space-y-6">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('front.review.create', ['transaction_id' => $transaction->id])); ?>" class="bg-black text-white py-3 px-6 rounded-md">Beri Penilaian</a>
                <?php endif; ?>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\Backend\java-juice\resources\views/front/orders/show.blade.php ENDPATH**/ ?>