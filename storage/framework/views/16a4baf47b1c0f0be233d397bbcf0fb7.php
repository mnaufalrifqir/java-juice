...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0">
            ...
            <a href="<?php echo e(route('admin.categories.create')); ?>" class="font-bold py-2 px-4 sm:px-6 bg-white text-gray-800 border rounded-full text-sm sm:text-base">
                + Tambah Baru
            </a>
        </div>
     <?php $__env->endSlot(); ?>
                ...
                <table class="min-w-full bg-white">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="py-2 px-4 border-b text-center text-sm"><?php echo e($category->id); ?></td>
                                <td class="py-2 px-4 border-b text-center text-sm"><?php echo e($category->name); ?></td>
                                <td class="py-2 px-4 border-b">
                                    <div class="flex justify-center items-center space-x-3 text-sm">
                                        <a href="<?php echo e(route('admin.categories.edit', $category->id)); ?>" title="Ubah" class="text-blue-600 hover:text-blue-800">
...
<?php endif; ?>
<?php /**PATH /home/java5379/public_html/test.javajuice.id/resources/views/admin/categories/index.blade.php ENDPATH**/ ?>