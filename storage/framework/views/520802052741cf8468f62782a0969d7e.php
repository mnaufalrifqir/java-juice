  ...
  <section class="container mx-auto py-16 px-6">
     ...
     <div class="flex flex-wrap justify-center">
      <div class="w-full md:w-1/4 p-4 text-center">
       <div class="bg-white p-6 rounded-lg shadow-md">
        <i class="fas fa-briefcase text-yellow-500 text-4xl mb-4">
        </i>
      ...
      <div class="w-full md:w-1/4 p-4 text-center">
       <div class="bg-white p-6 rounded-lg shadow-md">
        <i class="fas fa-tags text-yellow-500 text-4xl mb-4">
        </i>
        <h3 class="text-xl font-bold mb-2">
         Competitive Price
        </h3>
      ...
      <div class="w-full md:w-1/4 p-4 text-center">
       <div class="bg-white p-6 rounded-lg shadow-md">
        <i class="fas fa-clock text-yellow-500 text-4xl mb-4">
        </i>
        <h3 class="text-xl font-bold mb-2">
         On Time
        </h3>
      ...
      <div class="w-full md:w-1/4 p-4 text-center">
       <div class="bg-white p-6 rounded-lg shadow-md">
        <i class="fas fa-shield-alt text-yellow-500 text-4xl mb-4">
        </i>
        <h3 class="text-xl font-bold mb-2">
         Best Materials
        </h3>
   ...
   <section class="container mx-auto py-16 px-6">
    <div class="text-center mb-12">
     ...
     <a class="bg-yellow-500 text-white py-2 px-4 rounded-lg" href="#">
      View All Team
     </a>
    </div>
    <div class="flex flex-wrap justify-center">
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\Backend\java-juice\resources\views/front/about.blade.php ENDPATH**/ ?>